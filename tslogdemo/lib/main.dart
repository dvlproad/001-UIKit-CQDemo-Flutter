...
class DevUtil {
  ...
  static init_demo() {
    GlobalKey<NavigatorState> globalKey = MyApp.navigatorKey;
    DevUtil.init(
      navigatorKey: globalKey,
      // floatingToolImageProvider: floatingToolImageProvider,
      floatingToolTextNetworkNameOrigin: '开1',
      floatingToolTextNetworkNameCurrent: '测1',
      floatingToolTextTargetNameOrigin: '蒲',
      floatingToolTextTargetNameCurrent: 'TF',
      onFloatingToolDoubleTap: (bContext) {
        //
      },
      overlayEntryShouldShowIfNil: true,
    );
  }

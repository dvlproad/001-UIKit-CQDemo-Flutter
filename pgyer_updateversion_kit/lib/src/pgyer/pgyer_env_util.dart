 ...
 * @LastEditTime: 2022-07-16 18:18:33
...
class PgyerEnvUtil {
  ...
  static PgyerAppBean _diffPackageBean_dev = PgyerAppBean(
    pgyerAppType: UpdateAppType.develop1,
    des: '开发包',
    // bestNetworkDes: TSEnvironmentDataUtil.networkModel_dev1.name,
    downloadUrl: 'https://www.pgyer.com/Jzqc',
  ...
  static PgyerAppBean _diffPackageBean_preproduct = PgyerAppBean(
    pgyerAppType: UpdateAppType.preproduct,
    des: '测试包',
    // bestNetworkDes: TSEnvironmentDataUtil.networkModel_preProduct.name,
    downloadUrl: 'https://www.pgyer.com/bjtkewish',
  ...
  static PgyerAppBean _diffPackageBean_product = PgyerAppBean(
    pgyerAppType: UpdateAppType.product,
    des: '生产包',
    // bestNetworkDes: TSEnvironmentDataUtil.networkModel_product.name,
    downloadUrl: 'https://www.pgyer.com/app_bj',
  ...
  static PgyerAppBean diffPackageBeanByType(UpdateAppType _platformState) {
    if (_platformState == UpdateAppType.develop1) {
      return _diffPackageBean_dev;
    } else if (_platformState == UpdateAppType.develop2) {
      return _diffPackageBean_dev;
    } else if (_platformState == UpdateAppType.preproduct) {
      return _diffPackageBean_preproduct;
    } else if (_platformState == UpdateAppType.product) {

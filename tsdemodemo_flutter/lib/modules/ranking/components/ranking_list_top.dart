    ...
    return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(_nickName, style: TextStyle(color: Color(0xFFC4C4C4), fontSize: fontSize)),
            SizedBox(height: 30),
            Text('影响力', textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 16)),
            SizedBox(height: 2),
            Text(_influence.toString() + 'w', textAlign: TextAlign.center, style: TextStyle(color: Color(0xFFFFFFFF), fontSize: 18)),
            SizedBox(height: 6),
          ],
        )
    );

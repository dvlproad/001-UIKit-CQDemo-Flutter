    ...
    sectionModels = [
      {
        'theme': "单条信息的弹窗视图",
        'values': [
          { 'title': "MessageAlertPage", 'content': '单条信息的弹窗视图显示测试', 'nextPageName': "MessageAlertPage" },
      ...
      },
      {
        'theme': "多条信息的弹窗视图",
        'values': [
          { 'title': "ListMessageAlertPage", 'content': '多条信息的弹窗视图显示测试', 'nextPageName': "ListMessageAlertPage" },
      ...
      },
      {
        'theme': "单输入框的弹窗视图",
        'values': [
          { 'title': "TextInputAlertPage", 'content': '单输入框的弹窗视图显示测试', 'nextPageName': "TextInputAlertPage" },
      ...
      },
      {
        'theme': "多输入框的弹窗视图",
        'values': [
          { 'title': "ListTextInputAlertPage", 'content': '多输入框的弹窗视图显示测试', 'nextPageName': "ListTextInputAlertPage" },

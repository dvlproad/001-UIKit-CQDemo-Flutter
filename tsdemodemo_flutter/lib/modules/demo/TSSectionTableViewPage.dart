...
import 'package:tsdemodemo_flutter/commonui/cjts/tableview/CJTSTableHomeBasePage.dart';

class TSSectionTableViewPage extends CJTSTableHomeBasePage {
  final String title;
...
class _CJTSTableHomeBasePageState extends CJTSTableHomeBasePageState<TSSectionTableViewPage> {
  var sectionModels = [];
  ...
  void initState() {
    ...
    var sectionModels2 = [
      ...
      { 'theme': "图片相关",
        'values': [
          { 'title': "TSPhotoBrowserPage(图片浏览)", 'nextPageName': "TSPhotoBrowserPage" },
        ]
      },
      { 'theme': "其他",
        'values': [
          ...
          { 'title': "TSVerticalMenuCollectionPage(竖直菜单)", 'nextPageName': "TSVerticalMenuCollectionPage" },

...
Future<T> postUrl<T>(url, {Map<String, dynamic> params, cancelToken, JsonParse<T> jsonParse}) async {
  if (cancelToken == null) {
    cancelToken = CancelToken();
  }

  try {
    BaseOptions options = BaseOptions(connectTimeout: 60000, receiveTimeout: 60000);

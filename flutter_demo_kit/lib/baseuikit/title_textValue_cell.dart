...
class CJTSImageTitleTextValueCell extends StatelessWidget {
  final Color? color;
  ...
  Widget build(BuildContext context) {
    return ImageTitleCommonValueWithHolderTableViewCell(
      ...
      leftRightPadding: this.leftRightPadding ?? 20.w_pt_demo,
      ...
      arrowImageType:
          arrowImageType ?? CJTSTableViewCellArrowImageType.arrowRight,
  ...
  Widget? _valueWidget(BuildContext bContext, {bool canExpanded = false}) {
    ...
    if (this.addDotForValue == true) {
      widgets.add(_dot(7));
      widgets.add(SizedBox(width: 10.w_pt_demo));
    }
  ...
  Widget _dot(double radius) {
    return Container(
      width: 2 * radius.w_pt_demo,
      height: 2 * radius.h_pt_demo,
      decoration: BoxDecoration(
        borderRadius: BorderRadius.all(Radius.circular(radius.w_pt_demo)),
        border: Border.all(
          color: const Color(0xFFFF7F00),
          width: radius.w_pt_demo,
          ...
          (textSubValue == null || textSubValue!.isEmpty)
              ...
              : Text(
                  ...
                  style: TextStyle(
                    color: showTextColor,
                    fontFamily: 'PingFang SC',
                    fontSize: this.textValueFontSize ?? 10.f_pt_demo,
                    fontWeight: FontWeight.w400,
                    // height: 1,
                  ),
                ),

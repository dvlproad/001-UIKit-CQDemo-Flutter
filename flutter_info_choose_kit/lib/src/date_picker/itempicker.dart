// ignore_for_file: library_private_types_in_public_api, unused_field, non_constant_identifier_names, unused_element, unused_local_variable, no_leading_underscores_for_local_identifiers, avoid_unnecessary_containers
...
class CJStateTextButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (enable) {
      _onPressed = onPressed; // 这里是用 onPressed 的是否为空，来内部设置 enable 属性的
    } else {
          ...
          backgroundColor: MaterialStateProperty.resolveWith(
            (states) {
              ...
              if (states.contains(MaterialState.pressed)) {
                return const Color(0xFFFF7F00).withOpacity(0.12);
              }
              //默认不使用背景颜色

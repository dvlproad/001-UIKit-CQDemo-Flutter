 ...
 * @LastEditTime: 2023-09-25 11:53:08
 * @Description: 
 */
import 'dart:async';
import 'dart:convert';
...
import 'ts_toomany_image_optimize_check_util.dart';
...
class TSTooManyImageHomePage extends StatefulWidget {
  ...
  @override
  _TSTooManyImageHomePageState createState() => _TSTooManyImageHomePageState();
}

class _TSTooManyImageHomePageState extends State<TSTooManyImageHomePage> {
  String bgUrl =
          ...
          ListView(
            children: [
              ...
              _renderItem(
                ...
                alignment: Alignment.centerLeft,
                onTap: () async {
                  TSTooManyImageOptimizeCheckUtil.checkImageFindDuration();
                },
              ),
              _renderItem(
                title:
                ...
                onTap: () async {
                  ...
                  int imageWidthStart = vientianeImageWidthEnd;
                  int imageWidthEnd = vientianeImageWidthEnd + 100;
                  TSTooManyImageDownloadUtil.simulate_download_too_many(
                      imageWidthStart, imageWidthEnd);

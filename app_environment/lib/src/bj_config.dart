...
class BJConfig {
  ...
  static const String monitorApiHost = String.fromEnvironment('MONITOR_API_HOST');
  static const String monitorDataHubId = String.fromEnvironment('MONITOR_DATA_HUB_ID');

 ...
 * @LastEditTime: 2023-03-17 21:29:28
...
// 自定义相机
import './pick_take_photo_util.dart';
...
class PickAssetEntityUtil {
  ...
  static Future<AssetEntity?> _pickFromCamera(BuildContext context) async {
    return PickTakePhotoUtil.takePhoto();
  }
